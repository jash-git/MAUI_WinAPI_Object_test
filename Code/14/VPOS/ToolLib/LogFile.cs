...
namespace VPOS
{
    public class LogFile
    {
        ...
        public static bool m_blnSQLRecord = false;//
        public static void SQLRecord(String StrData)
        {
            if(!m_blnSQLRecord)
            {
                return;
            ...
            {
                String StrLogPath = m_StrSysPath + "Log";
                String StrFileName = StrLogPath + String.Format("\\SQLRecord_{0}.log", DateTime.Now.ToString("yyyyMMdd"));
